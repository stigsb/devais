 ...
 *
 * Board: 36x140mm, mounted vertically in chassis half along right wall.
...
export default () => (
  <board width="36mm" height="140mm" autorouter="auto-local">
    ...
    <chip name="J_USB" footprint="soic8"
      ...
      pinAttributes={{
        VBUS1: { providesPower: true }, VBUS2: { providesPower: true },
        GND1: { providesGround: true }, GND2: { providesGround: true },
        SHIELD1: { providesGround: true }, SHIELD2: { providesGround: true },
      }} />
    ...
    <chip name="SW_PWR" footprint="pushbutton"
      ...
      pinAttributes={{ B: { requiresGround: true } }} />
    ...
    <chip name="J_BAT" footprint="pinrow2"
      ...
      pinAttributes={{
        BAT_P: { providesPower: true },
        BAT_N: { providesGround: true },
      }} />
    ...
    <chip name="U_REG" footprint="sot223"
      ...
      pinAttributes={{
        ...
        VOUT: { providesPower: true }, VOUT_TAB: { providesPower: true },
        GND: { requiresGround: true },
      }} />
    ...
    <capacitor name="C_REGIN" capacitance="10uF" footprint="0805"
      pcbX={-12} pcbY={-20} pcbRotation={90}
      supplierPartNumbers={{ jlcpcb: ["C15850"] }} />
    ...
    <capacitor name="C_REGOUT" capacitance="22uF" footprint="0805"
      pcbX={12} pcbY={-24} pcbRotation={90}
    ...
    {/* ── Audio section: mic connector + amp IC ─────────────── */}
    {/* Mic connector at Y=-8, amp at Y=3: 11mm vertical gap for routing */}
    <chip name="J_MIC" footprint="pinrow5"
      pcbX={-10} pcbY={-10} pcbRotation={90} schX={8} schY={-5}
      pinLabels={{
        pin1: "MIC_VCC", pin2: "MIC_GND", pin3: "MIC_WS",
        pin4: "MIC_SCK", pin5: "MIC_SD",
      }}
      pinAttributes={{
        MIC_VCC: { requiresPower: true },
        MIC_GND: { requiresGround: true },
      }} />
    ...
    <chip name="U_AMP" footprint="qfn16"
      ...
      pinAttributes={{
        ...
        GND1: { requiresGround: true }, GND2: { requiresGround: true },
        GND3: { requiresGround: true }, GND4: { requiresGround: true },
      }}
      connections={{
        VDD: "net.VCC3V3",
        GND1: "net.GND", GND2: "net.GND", GND3: "net.GND", GND4: "net.GND",
        BCLK: "net.I2S_SCK", LRCLK: "net.I2S_WS", DIN: "net.I2S_SDO",
        OUT_P: "net.SPK_P", OUT_N: "net.SPK_N",
        SD_MODE: "net.VCC3V3", GAIN: "net.GND",
      }} />
    ...
    <chip name="U_MCU" footprint="dip14"
      ...
      pinAttributes={{
        ...
        GND: { requiresGround: true },
        "5V": { requiresPower: true },
      }}
      connections={{
        "3V3": "net.VCC3V3", GND: "net.GND", "5V": "net.VBUS",
        D6: "net.I2S_SCK", D7: "net.I2S_WS",
        D2: "net.I2S_SDI", D3: "net.I2S_SDO",
        D4: "net.BTN_PTT", D5: "net.BTN_PWR",
        D8: "net.LED_DATA", D9: "net.LED_EN",
      }} />
    ...
    {/* ── Speaker connector (near amp) + LED section ────────── */}
    <chip name="J_SPK" footprint="pinrow2"
      pcbX={14} pcbY={12} schX={12} schY={5}
      pinLabels={{ pin1: "SPK_P", pin2: "SPK_N" }}
      pinAttributes={{ SPK_P: { requiresPower: true }, SPK_N: { requiresGround: true } }} />
    <trace from=".J_SPK > .SPK_P" to="net.SPK_P" />
    <trace from=".J_SPK > .SPK_N" to="net.SPK_N" />

    <chip name="J_LED" footprint="pinrow3"
      pcbX={6} pcbY={63} schX={12} schY={0}
      pinLabels={{ pin1: "VDD_LED", pin2: "GND", pin3: "LED_DATA" }}
      pinAttributes={{
        VDD_LED: { requiresPower: true },
        GND: { requiresGround: true },
      }} />
